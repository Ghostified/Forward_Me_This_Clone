error id: file://<WORKSPACE>/app/controllers/ForwardPostController.java
file://<WORKSPACE>/app/controllers/ForwardPostController.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[6,2]

error in qdox parser
file content:
```java
offset: 109
uri: file://<WORKSPACE>/app/controllers/ForwardPostController.java
text:
```scala
package controllers;
...
QDox parse error in file://<WORKSPACE>/app/controllers/ForwardPostController.java